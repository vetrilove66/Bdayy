    ...
    <section className="py-24 relative z-10">
      <div className="container mx-auto px-4 text-center">
        ...
        <motion.p
          ...
          dangerouslySetInnerHTML={{ __html: "Wishes You Many More Happy returns of the day Abinash Anney. Epavum Happppy Ah irunga💕 Thambi epavumm Irupenn with u🫂🥰 ur smile and happiness is imp for us😻<br />Returns Happy Birthday Abinash Anney💛" }}
        />
      </div>
