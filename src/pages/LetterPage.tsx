              ...
              >
                ...
                <div className="space-y-6 text-muted-foreground text-base md:text-lg leading-relaxed font-light tracking-wide">
                  <motion.p initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
                    ...
                    Ivlo naal epdiyo ini vara  days Alagaaa irukatummm seriya... Amma Appa Oda Blessings✨Epavumee irukum😇
                  </motion.p>
                  <motion.p initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}>
                    Neenga Epavumeee Nalla happppyaaa nimathiyaaaa Irukanumm Anney💛for my wish....neengaaa epavume yarium
                    hurt pannatha person so ipdiye Ellaraium hpy ya vachukongaaa annney🥰👻
                    Yes Neenaga oru gem Tha anney💎 someones ungala deserve pannala .... so vittu poitanga....
                    neenag avngala nenachu laam feel pannama unga worth ye nenachu hpy ya irukanum seriya Thangamee🫂💌 
                

                  </motion.p>
                  <motion.p initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }}>
          
                  When I feel Alone that time ungal ta vandhuruven.👻 You are a gem anney💎
                  I don't ecxpet u anything .... ur luv and and care is enough Annney🫂
                  Idhu mari epavum hpyy ya irukanum thats enough Thangamee❤️‍🩹
